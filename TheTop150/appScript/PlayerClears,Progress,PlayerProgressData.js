...
IkglClears = [Daphnes_Finale, Aya_Revive, Ultimate_Speedrun, Final_Challenge_Speedrun, YuHo_160, Singularity, Happy_New_Year, Parousia, Precisely, Amorous, Bouquet, Oracion, Happy_Place, Quintet, 森永宅浪]
...
JuGeMuClears = [Ultimate_Speedrun, Happy_New_Year, Singularity, Final_Battle, SuperSpeedrun100, SuperSpeedRun130, Four_Devas, Happy_Place, Nightmare, We_Were_Reborn]
JuGeMuProgressLevel = []
...
JCTheChampClears = [Insomniac, Greater_Fusion, Yoshivenetus, Iced_desrt, Frozen_Eclipse, Kaizo_Encounters, No_Hay_Manera, Magma_Shells, Glacial, Rain, Scarlet, Biting_Blizzard, Shellcuslovania, Messy_Shadows, Arduous_Aqueducts, Verdant, Legacy, GlacialEclipse, Calamitous]
...
HJ_SanyxClears = [GlacialEclipse, BoF, Frozen_Eclipse, Scarlet] 
...
RyanClears = [Scarlet, Fiery_Wind_Blaster]
...
ちらしなClears = [Happy_Place, Nightmare]
ちらしなProgressLevel = [0]
ちらしなProgress = [0]
...
よぅいるぼんじんClears = [Ultimate_Speedrun, Quintet, The_Last_Memories, Regain_Peace, Speedrun120, Chimera, Crossing_Indignation]
...
ZoneßテテイーClears = [Death_Escape, Rainbow]
