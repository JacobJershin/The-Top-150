function LeaderBoard () {
  ...
  //This is the start of the nerf insert vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
        ...
        if (MasterClears[PlayerID][index] == Scarlet_Stronghold_Double || MasterClears[PlayerID][index] == VenetusDouble || MasterClears[PlayerID][index] == ScarletStrongholdPswitchx3 || MasterClears[PlayerID][index] == GlacialEclipse) {
          MasterClears[PlayerID][index] += 10  //Making Nerf atribute
                  NerfDetector += 1
        }
        index++
        }
  ...
  //This is the start of the nerf insert vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
      if (NerfDetector > 0) {
        if (MasterClears[PlayerID][index] == Scarlet_Stronghold_Double + 10 || MasterClears[PlayerID][index] == VenetusDouble + 10 || MasterClears[PlayerID][index] == ScarletStrongholdPswitchx3 + 10 || MasterClears[PlayerID][index] == GlacialEclipse + 10) {
          MasterClears[PlayerID][index] -= 10  //Removing Nerfs atribute
...
console.log("Finished the leaderboard execution")
